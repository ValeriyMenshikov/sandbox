...
class AccountServiceProxyAsyncStub:
    Login: UnaryUnaryMultiCallable[
        LoginRequest,
        LoginResponse,
    ]
...
class AccountServiceProxyServicer(metaclass=ABCMeta):
    @abstractmethod
    def Login(
        self,
...
def add_AccountServiceProxyServicer_to_server(servicer: AccountServiceProxyServicer, server: Union[Server, Server]) -> None: ...
