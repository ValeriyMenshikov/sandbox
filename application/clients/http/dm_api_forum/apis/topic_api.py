...
class TopicApi:
    ...
    async def get_v1_topics_id(
        ...
        **kwargs: Any,
        ...
        Returns:
                    TopicEnvelope: ...
        """  # noqa: D205,E501
        response = await self.get_v1_topics_id_with_http_info(
            id_=id_,
    ...
    async def get_v1_topics_id_with_http_info(
        self,
        id_: str,
        x_dm_auth_token: str = "",
        x_dm_bb_render_mode: str = "",
    ...
    async def patch_v1_topics_id(
        ...
        **kwargs: Any,
        ...
        Returns:
                    TopicEnvelope: ...
        """  # noqa: D205,E501
        response = await self.patch_v1_topics_id_with_http_info(
            id_=id_,
            topic=topic,  # noqa: E501
            x_dm_auth_token=x_dm_auth_token,
            x_dm_bb_render_mode=x_dm_bb_render_mode,
    ...
    async def patch_v1_topics_id_with_http_info(
        self,
        topic: Topic,  # noqa: E501
        id_: str,
        x_dm_auth_token: str,
    ...
    async def delete_v1_topics_id(
        ...
        **kwargs: Any,
        ...
        Returns:
                    None: ...
        """  # noqa: D205,E501
        response = await self.delete_v1_topics_id_with_http_info(
            id_=id_,
            x_dm_auth_token=x_dm_auth_token,
            x_dm_bb_render_mode=x_dm_bb_render_mode,
            **kwargs,
    ...
    async def delete_v1_topics_id_with_http_info(
        self,
        id_: str,
        x_dm_auth_token: str,
        x_dm_bb_render_mode: str = "",
    ...
    async def post_v1_topics_id__likes(
        self,
        id_: str,
        x_dm_auth_token: str,
        x_dm_bb_render_mode: str = "",
        **kwargs: Any,
        ...
        Returns:
                    UserEnvelope: ...
        """  # noqa: D205,E501
        response = await self.post_v1_topics_id__likes_with_http_info(
            id_=id_,
            x_dm_auth_token=x_dm_auth_token,
            x_dm_bb_render_mode=x_dm_bb_render_mode,
            **kwargs,
    ...
    async def post_v1_topics_id__likes_with_http_info(
        self,
        id_: str,
        x_dm_auth_token: str,
        x_dm_bb_render_mode: str = "",
        **kwargs: Any,
        ...
        response = await self.api_client.post(
            url=f"/v1/topics/{id_}/likes",
            headers=headers,
            **kwargs,
        )
        return response

    async def delete_v1_topics_id__likes(
        self,
        id_: str,
        x_dm_auth_token: str,
        x_dm_bb_render_mode: str = "",
        **kwargs: Any,
        ...
        Returns:
                    None: ...
        """  # noqa: D205,E501
        response = await self.delete_v1_topics_id__likes_with_http_info(
            id_=id_,
            x_dm_auth_token=x_dm_auth_token,
            x_dm_bb_render_mode=x_dm_bb_render_mode,
            **kwargs,
    ...
    async def delete_v1_topics_id__likes_with_http_info(
        self,
        id_: str,
        x_dm_auth_token: str,
        x_dm_bb_render_mode: str = "",
    ...
    async def get_v1_topics_id__comments(
        self,
        id_: str,
        skip: int,
        number: int,
        ...
        **kwargs: Any,
        ...
        Returns:
                    CommentListEnvelope: ...
        """  # noqa: D205,E501
        response = await self.get_v1_topics_id__comments_with_http_info(
            id_=id_,
            skip=skip,
            number=number,
            size=size,
        ...
        return CommentListEnvelope.model_validate_json(response.text)

    async def get_v1_topics_id__comments_with_http_info(
        self,
        id_: str,
        skip: int,
        number: int,
    ...
    async def post_v1_topics_id__comments(
        self,
        ...
        **kwargs: Any,
        ...
        Returns:
                    CommentEnvelope: ...
        """  # noqa: D205,E501
        response = await self.post_v1_topics_id__comments_with_http_info(
            id_=id_,
            comment=comment,  # noqa: E501
            x_dm_auth_token=x_dm_auth_token,
            x_dm_bb_render_mode=x_dm_bb_render_mode,
    ...
    async def post_v1_topics_id__comments_with_http_info(
        self,
        comment: Comment,  # noqa: E501
        id_: str,
        x_dm_auth_token: str,
    ...
    async def delete_v1_topics_id__comments_unread(
        self,
        id_: str,
        x_dm_auth_token: str,
        x_dm_bb_render_mode: str = "",
        **kwargs: Any,
        ...
        Returns:
                    None: ...
        """  # noqa: D205,E501
        response = await self.delete_v1_topics_id__comments_unread_with_http_info(
            id_=id_,
            x_dm_auth_token=x_dm_auth_token,
            x_dm_bb_render_mode=x_dm_bb_render_mode,
            **kwargs,
    ...
    async def delete_v1_topics_id__comments_unread_with_http_info(
        self,
        id_: str,
        x_dm_auth_token: str,
        x_dm_bb_render_mode: str = "",
        **kwargs: Any,
        ...
        response = await self.api_client.delete(
            url=f"/v1/topics/{id_}/comments/unread",
            headers=headers,
            **kwargs,
        )
        return response
