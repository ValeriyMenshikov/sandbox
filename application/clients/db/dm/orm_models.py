...
class Message(Base):
    ...
    Conversation = relationship(
        "Conversation",
        primaryjoin="Message.ConversationId == Conversation.ConversationId",
    )
...
class Tag(Base):
    ...
    TagGroupId = Column(
        ForeignKey("TagGroups.TagGroupId", ondelete="CASCADE"),
        nullable=False,
        index=True,
    )
    Title = Column(Text)
...
class CharacterAttribute(Base):
    ...
    CharacterId = Column(
        ForeignKey("Characters.CharacterId", ondelete="CASCADE"),
        nullable=False,
        index=True,
    )
    Value = Column(Text)
...
class RoomClaim(Base):
    ...
    ParticipantId = Column(
        ForeignKey("Readers.ReaderId", ondelete="CASCADE"),
        ForeignKey("Characters.CharacterId", ondelete="CASCADE"),
        nullable=False,
        index=True,
    )
